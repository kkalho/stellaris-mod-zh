...
![收录](https://img.shields.io/badge/收录-2010%20Mod-blue)
...
- 🎮 **多游戏支持**：群星（完整 2010 MOD）/ 十字军之王 3 / 钢铁雄心 4（框架就绪）
- 🔍 **智能搜索**：中文 / 英文 / **拼音**（`jugou`→巨构）/ 同义词（`巨型建筑`→巨构）
- 📚 **预翻译知识库**：群星 2010 个热门 Mod，中文覆盖率 100%
...
知识库数据来自 Steam 创意工坊**订阅量排行**（官方页面内嵌数据，截至 2026-09-15 群星已收录前 2010 名）。
