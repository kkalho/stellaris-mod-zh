...
| P7.5 | **流派策展清单** | ✅ 已上线（2026-09-14） | 第一局/性能/多人三套清单（`curated_lists.json` + `/api/<game>/lists`），每套带库内冲突预检 + 一键复制/送入冲突面板 |
| P8 | 清单分享页 | ✅ 已上线（2026-09-16） | `?list=id1,id2` 打开即总览；`/api/<game>/list-brief`；流派清单与冲突面板可复制分享链接 |
